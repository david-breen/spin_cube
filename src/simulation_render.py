...
def main():
    ...
    while True:
        ...
        rO, rx, ry, rz = quaternion_rotation([1, 0, 0, 0], attitude_mat)
        ...
        verts = [[0, 0, 0], (np.multiply([rx, ry, rz],3))]

        eds = ((0, 1), (0, 0))
        
        quaternion_movement(quaternion_rotation([1, 0, 0, 0], attitude_mat))

        draw_space_craft()
        draw_misc_lines(verts, eds)
